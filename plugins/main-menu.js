...
let tags = {
  'crow': '👑「 *`MENUS 𝐋𝐈𝐀𝐌 𝖡̶⃨͠𝐎𝗧ۚ𖬲็̹͛`* 」👑',
  'main': '「INFO」👑',
  'teclado': '「TECLADO LIAMBOT」👑',
  'buscador': '「BUSQUEDAS」👑',
  'fun': '「JUEGOS」👑',
  'serbot': '「SUB BOTS」👑',
  'rpg': '「RPG」👑',
...
const vid = ['https://files.catbox.moe/udcqxq.mp4', 'https://files.catbox.moe/udcqxq.mp4', 'https://files.catbox.moe/udcqxq.mp4']
...
await conn.sendMessage(m.chat, { video: { url: vid.getRandom() }, caption: text.trim(), contextInfo: { mentionedJid: [m.sender], isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: channelRD.id, newsletterName: channelRD.name, serverMessageId: -1, }, forwardingScore: 999, externalAdReply: { title: textbot, body: dev, thumbnailUrl: 'https://files.catbox.moe/nhnk4l.jpg', sourceUrl: redes, mediaType: 1, renderLargerThumbnail: false,
